...
def readOldIceExperi(varid,experi,level):
    """
    ...
    print('\n>>>Completed: Finished readOldIceExperi function!')
    return lat,lon,lev,varall
...
#experi = 'FICT'
#level = 'surface'   
#lat,lon,lev,var1 = readOldIceExperi(varid,experi,level)