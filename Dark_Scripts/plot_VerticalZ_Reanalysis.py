...
cbar.set_label(r'\textbf{[2019-2005]--[1993-1979] Z [m]}',color='k',
                         fontsize=6,labelpad=-27)

plt.subplots_adjust(bottom=0.2)

plt.savefig(directoryfigure + 'VerticalZ_Epoch_Reanalysis_%s.png' % datatitle,dpi=300)
...
plt.savefig(directoryfigure + 'VerticalZ_Troposphere_Epoch_Reanalysis_%s.png' % datatitle,dpi=300)