...
+ [2] Magnusdottir, G., **Z.M. Labe**, and Y. Peings. How does the atmospheric response to Arctic sea-ice decline compare to the full effect of the Arctic Amplification?, 2020 American Geophysical Union Annual Meeting, Virtual Conference (Dec 2020). [[Abstract]](https://agu.confex.com/agu/fm20/meetingapp.cgi/Paper/678706)
+ [3] Magnusdottir, G., **Z.M. Labe**, and Y. Peings. The midlatitude response to Arctic sea-ice decline, compared to the response to the full effects of Arctic amplification, 34th Conference on Climate Variability and Change, Virtual Conference (Jan 2021). [[Abstract]](https://ams.confex.com/ams/101ANNUAL/meetingapp.cgi/Paper/382356)
