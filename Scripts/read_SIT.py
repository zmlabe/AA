...
def readSIT(varid,timeperiod,level):
    """
    ...
    if timeperiod == 'SIT_Fu':
        ...
        print('-----------USING SC-WACCM4 THICKNESS EXPERIMENTS (Future)!-----------')
    elif timeperiod == 'SIT_Pd':
    ...
    print('>>>>>>>>>> Completed: Finished readSIT function!')
    return lat,lon,lev,var

###############################################################################
###############################################################################
### Test functions - do not use!
#lat,lon,lev,var1 = readSIT('Z500','SIT_Fu','surface')
#lat,lon,lev,var = readSIT('THICK','SIT_Pd','surface')