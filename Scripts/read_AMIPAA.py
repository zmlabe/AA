...
def readAMIPAAProfile(variableq,experiment,level,detrend,sliceeq,period,levelVert,epoch):
    ...
    print('\n>>> Completed: Finished readAMIPAAProfile function!')
...
#lat,lon,time,lev,diffa = readAMIPAAProfile(variable,experiment,level,
